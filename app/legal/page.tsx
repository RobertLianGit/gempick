  ...
  return (
    <div className="page-shell prose-page legal-page">
      ...
      <div className="legal-sections">
        <section><h2>非官方声明</h2><p>本站为非官方、非商业粉丝项目，与邓紫棋本人、工作室、唱片公司、经纪公司及音乐平台均无隶属、授权或代言关系。选择结果只表达单个使用者当下的个人偏好，不构成官方排名或公众投票。</p></section>
        ...
        <section><h2>本机数据</h2><p>歌曲选择、旅程编号、相遇顺序、完成进度和听歌平台偏好保存在当前设备的浏览器存储中。本站不建立账号，不读取音乐平台账号，也不主动收集姓名、邮箱、手机号、精确位置或公开排行榜数据。清除浏览器站点数据会同时清除这段选择的记录与平台偏好。</p></section>
